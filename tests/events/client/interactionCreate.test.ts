...
const interactionCreateEvent = require('../../../src/events/client/interactionCreate').default;
...
describe('InteractionCreate Event', () => {
  ...
  it('should execute command when interaction is chat input command', async () => {
    ...
    expect(mockCommand.execute).toHaveBeenCalledWith(mockInteraction, mockClient);
  });
